      ...
      <form onSubmit={handleSubmit(onSubmit)} className={"flex flex-col gap-7"}>
        <div className="flex flex-col gap-5 lg:flex-row">
          <div className="flex flex-col gap-2 lg:w-[48%]">
            ...
            {errors.firstName && (
              <span className=" text-yellow-25">
                Please Enter Firstname <sup>*</sup>
              </span>
            )}
          </div>
          ...
          <div className="flex flex-col gap-2 lg:w-[48%]">
            ...
            />
            {errors.lastName && (
              <span className=" text-yellow-25">Please Enter Lastname</span>
            )}
          </div>
        </div>
        ...
        <button
          ...
          className="rounded-md bg-yellow-50 px-6 py-3 text-center text-[13px] font-bold text-black
           shadow-[2px_2px_0px_0px_rgba(255,255,255,0.18)] transition-all duration-200 hover:scale-95
            hover:shadow-none  disabled:bg-richblack-500 sm:text-[16px] "
        >
          Send Message
        </button>
      </form>
